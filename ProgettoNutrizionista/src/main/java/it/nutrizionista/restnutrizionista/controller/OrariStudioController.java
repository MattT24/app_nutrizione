...
public class OrariStudioController {
     ...
     * Se non esistono, puoi decidere:
     * - far lanciare eccezione nel service (e gestirla con @ControllerAdvice)
     * - oppure restituire null / 404
     *
     * Io qui lascio che il service gestisca (come fai spesso negli altri controller).
     */
    @GetMapping("/me")
