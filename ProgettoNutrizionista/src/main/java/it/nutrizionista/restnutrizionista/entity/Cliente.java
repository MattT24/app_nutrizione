...
public class Cliente {
	...
	@Column(nullable = false, name = "problematiche_salutari")
	private String problematicheSalutari;
	@Column(nullable = false, name = "quantita_qualita_sonno")
	private String quantitaEQualitaDelSonno;
	@Column(nullable = false, name = "assunzione_farmaci")
    ...
    public void setMisurazioni(List<MisurazioneAntropometrica> misurazioni) {
